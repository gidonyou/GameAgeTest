...
#### LOCATION_FINDER (나침판) 
  - 드롭 : 3.82% → 5%
  - 효과 추가: 1등은 꼴찌의 위치를 확인할 수 있습니다. *(추가예정)*
    
#### PLAYER_TIME_ABOVE (많은시간)
  - 드롭 : 8.40% → 8%
  - 효과 추가: 1등은 꼴찌의 이름을 확인할 수 있습니다. *(추가예정)*
  
#### PLAYER_TIME_ABOVE (적은시간)
  - 드롭 : 8.40% → 8%
  - 효과 추가: 꼴찌는 1등의 이름을 확인할 수 있습니다. *(추가예정)*
  
#### PLAYER_TIME_LIST (시간 목록)
  - 드롭 : 4.58% → 3%
  - 패치: 0으로 시작되던 번호가 1로 시작합니다. *(추가예정)*
